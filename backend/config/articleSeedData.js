...
const TOPICS = {
  ...
  state: [
    { t: "State cabinet approves metro phase-2 land acquisition framework", th: "राज्य कैबिनेट ने मेट्रो फेज-2 भूमि अधिग्रहण ढांचे को मंजूरी दी", lede: "Officials said compensation panels will include elected local representatives for transparency.", hiLede: "अधिकारियों ने कहा कि पारदर्शिता के लिए मुआवजा पैनल में निर्वाचित स्थानीय प्रतिनिधि शामिल होंगे।" },
    { t: "Chief secretary reviews monsoon preparedness in coastal districts", th: "मुख्य सचिव ने तटीय जिलों में मानसून तैयारी की समीक्षा की", lede: "Teams checked cyclone shelters, diesel reserves for pumps, and evacuation route signage.", hiLede: "टीमों ने चक्रवात आश्रय, पंपों के लिए डीजल भंडार और निकासी मार्ग संकेतों की जाँच की।" },
    { t: "New industrial policy offers power tariff rebate for MSME clusters", th: "नई औद्योगिक नीति में एमएसएमई क्लस्टर के लिए बिजली टैरिफ छूट", lede: "The policy ties rebates to energy audits and adoption of approved efficiency equipment lists.", hiLede: "नीति छूट को ऊर्जा ऑडिट और स्वीकृत दक्षता उपकरण सूची अपनाने से जोड़ती है।" },
    { t: "Heritage board restores century-old civic hall with local crafts", th: "विरासत बोर्ड ने स्थानीय शिल्प से सदी पुराने नागरिक सभागार का जीर्णोद्धार किया", lede: "Artisans used traditional lime plaster mixes compatible with seismic retrofitting guidelines.", hiLede: "शिल्पकारों ने भूकंपीय रेट्रोफिटिंग दिशानिर्देशों के अनुकूल पारंपरिक चूना प्लास्टर मिश्रण का उपयोग किया।" },
    { t: "Transport department digitises learner licence appointments", th: "परिवहन विभाग ने लर्नर लाइसेंस नियुक्तियाँ डिजिटल कीं", lede: "Applicants can pick regional offices, upload documents once, and receive QR-coded tokens.", hiLede: "आवेदक क्षेत्रीय कार्यालय चुन सकते हैं, दस्तावेज़ एक बार अपलोड कर क्यूआर-कोडेड टोकन प्राप्त कर सकते हैं।" },
  ],
};
...
function buildPayloads(authorId, batchId) {
  ...
  for (const category of CATEGORIES) {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      const isBreaking = category === "politics" && i === 0 && seq === 0;
      out.push({
        title: row.t,
        titleHi: row.th,
        slug,
        ...
        category,
        tags: [category, "khabar-kothri", "khabar-seed-2026"],
        isBreaking,
        images: [
...
module.exports = { buildPayloads, SEED_TAG: "khabar-seed-2026" };

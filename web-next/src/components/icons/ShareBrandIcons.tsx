/**
 * Brand marks (WhatsApp, X, Facebook) — not shipped in lucide-react.
 * Pair with lucide `Link2` + `Share2` for copy-link and generic share.
 */
...
/** X (Twitter) logo */
export function IconXLogo({ size = 24, className, ...rest }: IconProps) {
  return (
    <svg
      width={size}
      height={size}

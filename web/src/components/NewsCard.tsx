...
const categoryColors: Record<string, string> = {
  politics: "#e53935", sports: "#00897b", tech: "#1565c0",
  business: "#e65100", entertainment: "#6a1b9a", health: "#2e7d32",
  world: "#283593", social: "#4e342e", environment: "#1b5e20",
  analysis: "#37474f", home: "#1565c0",
};
...
export default function NewsCard({ item, variant = "default", index = 0 }: NewsCardProps) {
  ...
  const category = lang === "hi" ? item.category : item.categoryEn;
    ...
    return (
      ...
      >
        ...
        <div className="card-h-body">
          ...
          <div className="card-meta"><Clock size={11} /><span>{time}</span></div>
        </div>
      </motion.article>
    );
  }
